...
public class ExamenFebrero {
	...
	public static void main(String[] args) {
		...
		do {
			...
			// si es válido lo guardo en o1 y en el tablero
			...
			// si es válido lo guardo en o2 y en el tablero
			if (usuarioMueveFicha(movimiento, tablero)) {
			...
			// si es válido lo guardo en o3 y en el tablero
			if (usuarioMueveFicha(movimiento, tablero)) {
...
//imprime el tablero con - en blanco, O ficha usuario y X ficha del programa
	...
	// crea una posición aleatoria. Comprueba que está la posición vacía y la
	...
	// convierte la posición introducida a movimiento
	...
	// usuario mueve ficha.Convierte el movimiento en posición y lo anota en el
	// vector
